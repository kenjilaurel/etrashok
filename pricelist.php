...
<head>
    ...
    <!-- Title Page-->
    <title>Junk Shop Price List</title>
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="images/icon/Etrashok-logo.png" alt="E-trashok" />
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a href="pricelist.php">
                                <i class="fas fa-usd"></i>Shop Price List</a>
                        </li>
                        <li>
                            <a href="additem.php">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                       <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Junk Shop Price List</h3>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>Household</td>
                                                <td class="desc">Cartons and cardboards</td>

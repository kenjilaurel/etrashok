                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">List of collector</li>
                        ...
                        <div class="card">
                          ...
                          <div class="card-body">     
                           <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">List of Collector</h3>
                                        ...
                                        <table class="table table-top-campaign sitio-table">
                                            <tbody>
                                            	...
                                            	$sql = "SELECT user.id uid,
                                                                ...
                                                                WHERE user.deleted = 0 AND user_role = 2";
				                                ...
				                                if (mysqli_num_rows($result) > 0) {         
				                                    ...
				                                    while($row = mysqli_fetch_assoc($result)) {
				                                    	...
				                                    	echo '<td>'.$name.'</td>';
                                                        echo '<td>'.$address.'</td>';
				                                    	echo '<td><span class="color-black" style="font-weight: 400;">Assigned to: </span>'.$row['sitio_name'].'</td>';
				                                    	echo '</tr>';
				                                    }
				                                }else{

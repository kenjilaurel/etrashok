        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Uncollected waste</li>
                                    </ul>
                                </div>
          ...
          <section class="p-t-60 p-b-20">
              <div class="container">
                  <div class="row">
                     	<div class="col-md-12">
                      		<h4>Uncollected waste from resident</h4>
                      		<hr/>
			                                    ...
			                                    ?>
				                                     <tr class="tr-shadow">                                               
		                                                <td>
		                                                	<div class="row">
		                                                		<div class="col-md-2">
			                                                		<?php echo '<span class="rname color-black">'.$count.'. '.$name.'</span>'; ?>
			                                                	</div>
			                                                	<div class="col-md-10">
																			...
																			if (mysqli_num_rows($resultcat) > 0) {  
																				...
																				<div class="remarks-content">
																					...
																					<div class="form-group">
																						<textarea name="remarks" class="form-control" placeholder="Write your remarks here..."></textarea>
																					</div>
																					<div class="row">
																						<div class="col-md-6">
																						...
																						<div class="col-md-6 text-right" style="padding-top: 1.5em;">
																							<input type="submit" name="collected" class="btn btn-primary" value="Collected">
																						</div>
																					</div>
																				</div><!-- remarks content -->
																				</form>
